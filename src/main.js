...
import { flyToStartupView, STARTUP_VIEW } from './camera.js';
...
async function init() {
  ...
  try {
    ...
    // If no share link state, do the default fly-to
    if (!styleManager.hasShareState) {
      loaderStatus.textContent = `Flying to ${STARTUP_VIEW.label}...`;
      flyToStartupView(viewer);
    } else {
